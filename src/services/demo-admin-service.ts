...
export const ACTIVITY_ANALYTICS = Object.freeze([
  {
    ...
    courseKey: "ocr-level-3-it",
    courseTitle: "OCR Level 3 IT",
    assignmentId: "assignment-a-diagnostic",
    activityId: "activity-diagnostic",
    activityKey: "foundations-programming-diagnostic",
    activityTitle: "Foundations Programming Diagnostic",
  ...
  },
  {
    ...
    courseKey: "ocr-level-3-it",
    courseTitle: "OCR Level 3 IT",
    assignmentId: "assignment-a-attacker-types",
    activityId: "activity-attacker-types",
    activityKey: "week3-attacker-types",
    activityTitle: "Week 3: Attacker Types",
    activityVersion: "0.2.10",
    assignedLearnerCount: 1,
    attemptedLearnerCount: 1,
    completedLearnerCount: 1,
    completionPercentage: 100,
    ...
    attemptCount: 3,
    completedAttempts: 3,
    averageScorePercentage: 71,
    bestScorePercentage: 82,
    latestScorePercentage: 82,
    requiresReviewCount: 0,
    reviewedResponseCount: 0,
    latestCompletedAt: "2026-09-01T09:00:00Z",
  },
  {
    groupCode: "TEST-GROUP-B",
    groupName: "Test Group B",
    courseKey: "ocr-level-3-it",
    courseTitle: "OCR Level 3 IT",
    assignmentId: "assignment-b-diagnostic",
    activityId: "activity-diagnostic",
    activityKey: "foundations-programming-diagnostic",
    activityTitle: "Foundations Programming Diagnostic",
    activityVersion: "2.0.0",
  ...
  },
  {
    ...
    courseKey: "ocr-level-3-it",
    courseTitle: "OCR Level 3 IT",
    assignmentId: "assignment-b-attacker-types",
    activityId: "activity-attacker-types",
    activityKey: "week3-attacker-types",
    activityTitle: "Week 3: Attacker Types",
    activityVersion: "0.2.10",
...
]) satisfies readonly ActivityAnalyticsRecord[];

export const LEARNER_ACTIVITY_PERFORMANCE = Object.freeze([
  {
    learnerId: "learner-a",
    studentNumber: "SYNTH-0001",
    displayName: "Synthetic Learner A",
    ...
    activityTitle: "Foundations Programming Diagnostic",
    activityVersion: "2.0.0",
    hubCodes: ["unit-3-cyber-security", "unit-14-software-engineering-for-business"],
    hubNames: ["Unit 3 Cyber Security Hub", "Unit 14 Software Engineering for Business Hub"],
    weekNumber: null,
    weekTitle: null,
    attemptCount: 1,
    ...
    bestScorePercentage: 80,
    averageScorePercentage: 80,
    firstCompletedAt: "2026-08-11T09:00:00Z",
    latestCompletedAt: "2026-08-11T09:00:00Z",
    requiresReviewCount: 0,
    reviewedResponseCount: 0,
  },
  {
    ...
    hubNames: ["Unit 3 Cyber Security Hub", "Unit 14 Software Engineering for Business Hub"],
    weekNumber: 3,
    weekTitle: "Attacker Types",
    attemptCount: 3,
    completedAttemptCount: 3,
    firstScorePercentage: 55,
    latestScorePercentage: 82,
    bestScorePercentage: 82,
    averageScorePercentage: 71,
    firstCompletedAt: "2026-08-20T09:00:00Z",
    latestCompletedAt: "2026-09-01T09:00:00Z",
    requiresReviewCount: 0,
    reviewedResponseCount: 0,
  },
...
]) satisfies readonly LearnerActivityPerformanceRecord[];

export const QUESTION_GROUP_PERFORMANCE = Object.freeze([
  {
    groupCode: "TEST-GROUP-A",
    groupName: "Test Group A",
    courseKey: "ocr-level-3-it",
  ...
  },
  {
    ...
    averageAwardedScore: 0,
    averageMaxScore: 1,
  },
]) satisfies readonly QuestionGroupPerformanceRecord[];
...
const DIAGNOSTIC_SESSIONS: readonly DiagnosticSessionRecord[] = Object.freeze([
  {
    sessionId: "diag-session-completed",
    studentName: "Alex Rivera",
    studentId: "STU1001",
    hubCode: "level-3-it-year-1-readiness",
    hubName: "Level 3 IT Year 1 Readiness Hub",
    courseKey: "ocr-level-3-it",
    courseTitle: "OCR Level 3 IT",
    diagnosticKey: "level-3-it-year-1-readiness",
    diagnosticVersion: "1.1.0",
    status: "completed",
    startedAt: "2026-09-02T09:00:00Z",
    completedAt: "2026-09-02T09:22:00Z",
    responseCount: 4,
    notSureCount: 2,
    awardedScore: 18,
    maxScore: 24,
  ...
  {
    sessionId: "diag-session-started",
...
const DIAGNOSTIC_RESPONSES: readonly DiagnosticResponseRecord[] = Object.freeze([
  {
    responseId: "diag-response-1",
    sessionId: "diag-session-completed",
    studentName: "Alex Rivera",
    studentId: "STU1001",
    hubCode: "level-3-it-year-1-readiness",
    courseKey: "ocr-level-3-it",
    activityId: "readiness-opening-confidence",
    unitKey: "general",
    topicKey: "confidence",
    questionKey: "RDY-OPEN-001",
    evidence: "somewhat",
    isNotSure: false,
    confidence: "somewhat",
    isCorrect: null,
  ...
  {
    responseId: "diag-response-2",
    sessionId: "diag-session-completed",
    studentName: "Alex Rivera",
    studentId: "STU1001",
    hubCode: "level-3-it-year-1-readiness",
    courseKey: "ocr-level-3-it",
    activityId: "readiness-gist-storage-media",
    unitKey: "global-information",
    topicKey: "storage",
    questionKey: "RDY-GIST-001",
    evidence: { usb: "device", letter: "not-sure" },
    isNotSure: true,
    confidence: null,
    isCorrect: false,
    awardedScore: 0,
    maxScore: 1,
    createdAt: "2026-09-02T09:06:00Z",
    updatedAt: "2026-09-02T09:06:00Z",
  },
  {
    responseId: "diag-response-3",
    sessionId: "diag-session-completed",
    studentName: "Alex Rivera",
    studentId: "STU1001",
    hubCode: "level-3-it-year-1-readiness",
    courseKey: "ocr-level-3-it",
    activityId: "readiness-fit-hardware",
    unitKey: "fundamentals-of-it",
    topicKey: "hardware-software",
    questionKey: "RDY-FIT-001",
    evidence: { optionId: "not-sure" },
    isNotSure: true,
    confidence: null,
    isCorrect: false,
    awardedScore: 0,
  ...
  {
    responseId: "diag-response-4",
    sessionId: "diag-session-completed",
    studentName: "Alex Rivera",
    studentId: "STU1001",
    hubCode: "level-3-it-year-1-readiness",
    courseKey: "ocr-level-3-it",
    activityId: "readiness-cyber-cia",
    unitKey: "cyber-security",
    topicKey: "cia",
    questionKey: "RDY-CYB-001",
    evidence: { optionId: "confidentiality" },
    isNotSure: false,
    confidence: null,
    isCorrect: true,
    awardedScore: 1,
    maxScore: 1,
    createdAt: "2026-09-02T09:18:00Z",
    updatedAt: "2026-09-02T09:18:00Z",
  },
  {
    responseId: "diag-response-5",
    sessionId: "diag-session-started",
    studentName: "Jordan Blake",
    studentId: "STU1002",
    hubCode: "level-3-it-year-1-readiness",
    ...
    awardedScore: null,
    maxScore: 0,
    createdAt: "2026-09-03T10:16:00Z",
    updatedAt: "2026-09-03T10:16:00Z",
  },
]);

const DIAGNOSTIC_SUMMARY: readonly DiagnosticSummaryRecord[] = Object.freeze([
  {
    hubCode: "level-3-it-year-1-readiness",
    courseKey: "ocr-level-3-it",
    startedCount: 2,
...
export const demoAdminService: AdminReadService = Object.freeze({
  ...
  async listLearnerActivityPerformance() { return LEARNER_ACTIVITY_PERFORMANCE; },
  async listActivityAnalytics() { return ACTIVITY_ANALYTICS; },
  async listQuestionPerformance() { return QUESTION_PERFORMANCE; },
  async listQuestionGroupPerformance() { return QUESTION_GROUP_PERFORMANCE; },
  ...
  async listDiagnosticSessions() { return DIAGNOSTIC_SESSIONS; },
  async listDiagnosticResponses() { return DIAGNOSTIC_RESPONSES; },
  async listDiagnosticSummary() { return DIAGNOSTIC_SUMMARY; },
});
...
export const DEMO_ADMIN_DATA: AdminDataSnapshot = Object.freeze({
  ...
  learnerActivityPerformance: LEARNER_ACTIVITY_PERFORMANCE,
  activityAnalytics: ACTIVITY_ANALYTICS,
  questionPerformance: QUESTION_PERFORMANCE,
  questionGroupPerformance: QUESTION_GROUP_PERFORMANCE,
  ...
  diagnosticResponses: DIAGNOSTIC_RESPONSES,
