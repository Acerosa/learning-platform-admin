...
export const ADMIN_MODULES: readonly AdminModuleDefinition[] = [
  ...
  { id: "curriculum", label: "Curriculum authoring", shortLabel: "CU", group: "Learning", eyebrow: "Curriculum administration", description: "Author canonical weeks, sessions and activities as local drafts.", capability: "curriculum.author", dataState: "partial" },
  ...
  { id: "attempts", label: "Attempts", shortLabel: "AT", group: "Operations", eyebrow: "Learning evidence", description: "Inspect safe submission summaries without learner response payloads.", capability: "attempts.read", dataState: "available" },
  { id: "analytics", label: "Analytics", shortLabel: "AN", group: "Operations", eyebrow: "Evidence and insight", description: "Review backend-derived activity and group performance summaries.", capability: "analytics.read", dataState: "available" },
