...
- Mutation controls remain pending until the backend documents the required role/action, except hub registration through `admin_api.register_hub` and curriculum publication through `admin_api.publish_curriculum`.
