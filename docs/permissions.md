...
- Mutation controls remain pending until the backend documents the required role/action, except curriculum publication through `admin_api.publish_curriculum`.
